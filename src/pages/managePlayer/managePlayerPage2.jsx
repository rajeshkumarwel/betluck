									...
									<div className="col-sm-12">
										<div className="card players-success mt-3">
											<div className="card-body text-center">
												<h4 className="mt-1"><strong>Succssfully frozen the player account</strong></h4>
												<div className="mb-1">
													<span className="text-muted">asha.vel@hotmail.com</span>
												</div>
												<div className="mb-1">
								...
								<table className="table table-hover my-0">
									...
									<tbody>
										...
										<tr>
											...
											<td><span className="badge bg-secondary">Frozen</span></td>
										</tr>
										<tr>
											<td>
                                                <div>suresh.raj@outlook.com</div>
...
export default ManagePlayerPage2;