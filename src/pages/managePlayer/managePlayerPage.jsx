        ...
        <div className="main">
			...
			<main className="content">
				...
				<div className="container-fluid p-0">
					...
					<h5 className="card-title mt-3 mb-2">Total players ({managePlayerInfomation?.players?.length})</h5>
						...
						<div className="col-12 col-lg-8 col-xxl-9 d-flex">
							<div className="card flex-fill">
								...
								<table className="table table-hover my-0">
									...
									<tbody>
										{managePlayerInfomation?.players?.map((item, index) => (
										<tr key={index}>
											<td>
                                                <div>
													<Link className="text-link" to={`/personalinfo/${item.playerId}`}>{item.email}</Link>
												</div>
                                                <div><small className="text-muted">{item.role}</small></div>
                                            </td>											
											<td>
