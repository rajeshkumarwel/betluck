									...
									<div className="col-sm-12">
										<div className="card players-success mt-3">
											<div className="card-body text-center">
												<h4 className="mt-1"><strong>Players name updated succssfully</strong></h4>												
											</div>
										</div>
									</div>									
								</div>
									...
									<tbody>
										...
										<tr>
											...
											<div><small className="text-muted">Withdraw UPI ID</small></div>
                                                <div><Link to={"/"}>Add withdraw address</Link></div>
                                            </td>
											<td></td>	
										</tr>
										<tr>
...
export default PersonalInfoUpdatePage1;